...
<div class="e_b">
  <div class="banner">
    <div class="sm_banner"><img src="<?php echo (TEMDIR_URL); ?>images/banner.jpg"/ width="2000" height="420"></div>
  </div>
</div>
<div id="content1">
  <div class="one">
    <ul class="one_ul">
      <li class="one_act" style="border-left:none;">镇店之宝</li>
      <li>热销商品</li>
      <li>推荐精品</li>
      <li>最新优惠</li>
      <div class="clear"></div>
  ...
  <div class="two">
  	<div class="two_top">
        <div class="h2_h">
          <div class="wz_w lf"></div>
          <div class="wz_r rg"><a href="#" class="limit_more">更多</a></div>
          <div class="clear"></div>
        </div>
        <div class="ad"><a href="#"><img src="<?php echo (TEMDIR_URL); ?>images/ad_pic.jpg" /></a></div>
     </div>
    <ul class="th_ul">
    	<li class="two_cp_li">
          <p><a href="#"><img src="<?php echo (TEMDIR_URL); ?>images/pic_01.jpg" /></a></p>
  ...
  <div class="th_top">
    <div class="h2_h">
      <div class="wz_m lf"></div>
      <div class="wz_r rg">
      <a href="#" class="limit_more">更多</a>
      </div>
      <div class="clear"></div>
    </div>
    <div class="ad"><a href="#"><img src="<?php echo (TEMDIR_URL); ?>images/ad_pic01.jpg" /></a></div>
    </div>
    <ul class="fo_ul">
          <li class="th_cp_li">
          <p><a href="#"><img src="<?php echo (TEMDIR_URL); ?>images/pic_01.jpg" /></a></p>
