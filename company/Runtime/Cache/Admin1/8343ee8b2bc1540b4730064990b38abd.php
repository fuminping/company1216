	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>添加问题</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal">
				  <fieldset>
					...
					<div class="control-group">
					  <label class="control-label" for="typeahead">问题标签 </label>
					  <div class="controls">
						<input type="checkbox" name="types[]" value="1"/>HTML 
						<input type="checkbox" name="types[]" value="2"/>CSS 
						<input type="checkbox" name="types[]" value="3"/>PHP 
						<input type="checkbox" name="types[]" value="4"/>ThinkPHP 
					  </div>
					</div>
					<div class="control-group">
					  <label class="control-label" for="typeahead">指定回答者 </label>
					  <div class="controls">
						<select name="hduser">
							<option value="1">--请选择--</option>
							<option value="2">carl</option>
							<option value="3">陈老师</option>
						</select>
					  </div>
					</div>
					<div class="control-group">
					  <label class="control-label" for="fileInput">附件上传</label>
					  <div class="controls">
						<div class="uploader" id="uniform-fileInput file_upload"><input class="input-file uniform_on" id="fileInput" type="file"><span class="filename" style="-webkit-user-select: none;">没有文件</span><span class="action" style="-webkit-user-select: none;">选择附件</span></div>
					  </div>
					</div>
					<div class="control-group hidden-phone">
					  <label class="control-label" for="textarea2">问题描述</label>
					  <div class="controls">
