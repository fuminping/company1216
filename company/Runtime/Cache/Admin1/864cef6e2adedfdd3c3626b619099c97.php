...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>商城管理系统</span></a>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li>
							...
							<ul>
								<li><a class="submenu" href="<?php echo U('Question/Index');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 添加商品</span></a></li>
								<li><a class="submenu" href="<?php echo U('Question/Add');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 商品列表</span></a></li>
								<li><a class="submenu" href="<?php echo U('Question/Questionsub');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 商品分类</span></a></li>
							</ul>	
						</li>
						<li><a class="dropmenu" href="#"><i class="icon-envelope"></i><span class="hidden-tablet"> 用户管理</span></a>
							<ul>
								...
								<li><a class="submenu" href="<?php echo U('User/Add');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 管理员列表</span></a></li>
								<li><a class="submenu" href="<?php echo U('User/Usersub');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 角色列表</span></a></li>
							</ul>	
						</li>
						<li><a class="dropmenu" href="#"><i class="icon-envelope"></i><span class="hidden-tablet"> 订单管理</span></a>
							<ul>
								<li><a class="submenu" href="<?php echo U('User/Index');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 订单列表</span></a></li>
							</ul>	
						</li>
						<li><a class="dropmenu" href="#"><i class="icon-envelope"></i><span class="hidden-tablet"> 评价管理</span></a>
							<ul>
								<li><a class="submenu" href="<?php echo U('User/Index');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 评价列表</span></a></li>
							</ul>	
						</li>
						<li><a class="dropmenu" href="#"><i class="icon-envelope"></i><span class="hidden-tablet"> 资讯管理</span></a>
							<ul>
								<li><a class="submenu" href="<?php echo U('User/Index');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 资讯列表</span></a></li>
							</ul>	
						</li>
						<li><a class="dropmenu" href="#"><i class="icon-envelope"></i><span class="hidden-tablet"> 广告管理</span></a>
							<ul>
								<li><a class="submenu" href="<?php echo U('User/Index');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 广告列表</span></a></li>
								<li><a class="submenu" href="<?php echo U('User/Index');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 广告分类</span></a></li>
							</ul>	
						</li>
						<li><a class="dropmenu" href="#"><i class="icon-envelope"></i><span class="hidden-tablet"> 统计管理</span></a>
							<ul>
								<li><a class="submenu" href="<?php echo U('User/Index');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 用户统计</span></a></li>
								<li><a class="submenu" href="<?php echo U('User/Index');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 销售额统计</span></a></li>
								<li><a class="submenu" href="<?php echo U('User/Index');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 商品统计</span></a></li>
							</ul>	
						</li>
						<li><a class="dropmenu" href="#"><i class="icon-tasks"></i><span class="hidden-tablet"> 权限管理</span></a>
							<ul>
								<li><a class="submenu" href="<?php echo U('Auth/Rolelist');?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> 用户权限</span></a></li>
	...
	<div id="content" class="span10">
		<ul class="breadcrumb">
			<li>
				<i class="icon-home"></i>
				<a href="<?php echo U('Question/Index');?>">用户管理</a>
				<i class="icon-angle-right"></i> 
			</li>
			<li>
				<i class="icon-edit"></i>
				<a href="<?php echo U('Question/Add');?>">用户列表</a>
			</li>
		</ul>
				...
				<div class="box-content">
				  <fieldset>
					<div class="control-group">
					  <span class="control-label" for="typeahead">用户名称: </span>
						<input type="text" class=" typeahead" id="typeahead" />
					  <span class="control-label">注册日期:</span>
						<input type="text" class="input-xlarge datepicker" id="date01" value="<?php echo $times ?>">
